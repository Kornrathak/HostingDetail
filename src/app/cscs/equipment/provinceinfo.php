<div>
    ...
    <div class="col-md-12 col-sm-12 ">
        ...
        <?php
            ...
            echo '<tr><th scope="col" colspan="2" bgcolor="#99FFFF"><a href="http://localhost/HostingDetail/src/app/cscs/equipment/province-edit.php?id='.$d_province['id'].'" class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span> <strong>แก้ไขรายละเอียดสถานี</strong></a></th></tr>';
