<div>
    ...
    <div class="col-md-12 col-sm-12 ">
        ...
        <?php
            while($d_province=mysql_fetch_array($r_province)){
                ...
                echo '<tr><th scope="col" colspan="2" bgcolor="#99FFFF"><a href="<path/to/editpage>?id="'.$d_province['id'].'" class="btn btn-primary"><strong>แกไขรายละเอียดสถานี</strong></a></th></tr>';
